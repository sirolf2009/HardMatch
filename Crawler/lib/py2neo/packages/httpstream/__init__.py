...
from .Spider.WebCrawler.lib.py2neo.packages.httpstream.http import *
...
def download(uri, filename=None, headers=None, redirect_limit=5, **kwargs):
    ...
    from .Spider.WebCrawler.lib.py2neo.packages.httpstream.tardis import datetime_to_timestamp
    try:

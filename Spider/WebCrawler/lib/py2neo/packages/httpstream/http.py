...
from .Spider.WebCrawler.lib.py2neo.packages.httpstream.packages.urimagic import URI, URITemplate
from .Spider.WebCrawler.lib.py2neo.packages.httpstream.packages.urimagic.util import xstr
from .Spider.WebCrawler.lib.py2neo.packages.httpstream.packages.urimagic.kvlist import KeyValueList  # no point in another copy

from . import __version__
from .Spider.WebCrawler.lib.py2neo.packages.httpstream.jsonencoder import JSONEncoder
from .Spider.WebCrawler.lib.py2neo.packages.httpstream.numbers import *
...
class JSONResponse(TextResponse):
    ...
    def __iter__(self):
        ...
        try:
            ...
            from ..Spider.WebCrawler.lib.py2neo.packages.jsonstream import JSONStream

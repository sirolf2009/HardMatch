...
from .Spider.WebCrawler.lib.py2neo.packages.httpstream.packages.urimagic.rfc3986 import *
from .Spider.WebCrawler.lib.py2neo.packages.httpstream.packages.urimagic.rfc6570 import *

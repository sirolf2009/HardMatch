...
public class MatcherHeartBeatOptions extends UpdatingLineChartOptions {
	...
	public MatcherHeartBeatOptions() {
		setTitle(new Title("Matcher Heartbeat"));
		series = new LiveDataSeries(this, 5000) {
			...
			public Point update(LiveDataUpdateEvent event) {
				long currentHeartBeat = WicketApplication.instance.getLastMatcherHeartBeat();
